...
import 'package:zomato_ui/Modules/home_page.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case changeThemeScreen:
        ...
        break;
      case detailScreen:
        String tag = settings.arguments.toString();

        routePage = DetailScreen(heroTag: tag,);
        break;
      default:
        routePage = const SplashScreen();
        break;
    ...
    return PageRouteBuilder(transitionDuration: const Duration(milliseconds: 300),
